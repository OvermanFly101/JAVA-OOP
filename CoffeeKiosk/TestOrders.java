...
public class TestOrders {
    public static void main(String[] args) {
        ...
        CoffeeKiosk coffeeMenu = new CoffeeKiosk();
        coffeeMenu.addMenuItem(item1);
        coffeeMenu.addMenuItem(item2);
        coffeeMenu.addMenuItem(item3);
        coffeeMenu.addMenuItem(item4);
        coffeeMenu.newOrder();
